...
class Agent(Base):
    ...
    widget_primary_color = Column(Text, nullable=True)
    widget_text_color = Column(Text, nullable=True)
    widget_background_color = Column(Text, nullable=True)
    widget_border_width_container = Column(Integer, nullable=True)
    widget_border_width_message = Column(Integer, nullable=True)
    widget_border_width_button = Column(Integer, nullable=True)
