...
def read_feature_tools(
    ...
    try:
        tools, pagination = list_feature_tools(session, feature_id, clerk_session.user_id, page)
        log_info("FeaturesController", "read_feature_tools", "Tools fetched", user_id=clerk_session.user_id, feature_id=str(feature_id))
        ...
        log_error("FeaturesController", "read_feature_tools", "Failed to fetch tools", exc=error, user_id=clerk_session.user_id, feature_id=str(feature_id))
