...
Pick the best-fit primary lead first (usually PL, SL, or TL), then add 1 adjacent lead on Day 8.
...
| 2 | Email 1 | Primary lead | Short, trigger-led, pain-first email. CTA: “Open to a 2-minute teardown?” | Send in their local late morning. Do not ask for a demo yet. |
...
| 6 | Email 2 | Primary lead | New angle by persona: PL = adoption, SL = ticket deflection, TL = AI-native without internal build. | Each touch must change angle. Offer a custom Loom / teardown. |
| 7 | LinkedIn DM | Primary lead (if connected) | “Thanks for connecting — noticed [trigger]. Happy to send a quick teardown on where Warpy could help.” | Very short, permission-based DM. |
| 8 | Email / LinkedIn | Adjacent lead (PL / SL / TL / CL) | Start multithreading with a different KPI angle. | Same account, different pain. |
| 10 | Email 3 | Primary lead | Add proof: short case study, metric, or a concrete workflow Warpy could handle in their UI. | Fresh value only. No repeated pitch. |
...
| 14 | Email 4 or LinkedIn DM 2 | Most engaged lead | Send the asset: teardown, screenshot, 60-sec Loom, use-case note, benchmark. | Follow the channel where they showed interest. |
| 17 | Email | Primary or adjacent lead | Pure value touch: ungated resource, teardown, benchmark, or useful note. No hard CTA. | This is the “give” touch. |
| 21 | Email | Primary lead | Close-the-loop email: “Seems like this isn’t a priority now, or I missed the mark…” | Polite breakup. Leaves the door open. |

Best-practice rules baked into this sequence: warm intro first, multithread early, every touch adds a new angle, X only if the buyer is clearly active, and founder-led outreach is preferred for Warpy.
